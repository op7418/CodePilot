...
export const VENDOR_PRESETS: VendorPreset[] = [
  ...
  // ── Zhipu GLM (China) ──
  {
    ...
    defaultEnvOverrides: { API_TIMEOUT_MS: '3000000', ANTHROPIC_API_KEY: '', ANTHROPIC_DEFAULT_HAIKU_MODEL: 'glm-5', ANTHROPIC_DEFAULT_SONNET_MODEL: 'glm-5-turbo', ANTHROPIC_DEFAULT_OPUS_MODEL: 'glm-5.1' },
    defaultModels: [
      ...
      { modelId: 'haiku', upstreamModelId: 'haiku', displayName: 'GLM-5', role: 'haiku' },
    ],
    fields: ['api_key'],
    iconKey: 'zhipu',
    sdkProxyOnly: true,
