...
const en = {
  ...
  "cli.proxy": "Proxy Server",
  "cli.proxyDesc":
    "HTTP/HTTPS proxy for Claude CLI network requests (e.g. http://127.0.0.1:7890). Leave empty to use system proxy.",
  "cli.proxyPlaceholder": "http://127.0.0.1:7890",
  ...
  "bridge.qqChannel": "QQ",
  "bridge.qqChannelDesc":
    "Receive and respond to messages via QQ Bot (private chat)",
  ...
  "qq.allowedUsersDesc":
    "Comma-separated user_openid values allowed to use bridge",
  ...
  "qq.step1":
    "Go to QQ Bot Quick Setup page (q.qq.com/qqbot/openclaw) to create a bot and generate App ID & App Secret",
  ...
  "qq.step4":
    "Go back to the Bridge page, enable the QQ channel toggle, and start the bridge",
  "qq.step5":
    "Add your QQ bot as a friend and send it a message to start chatting",

  // ── Assistant Workspace ──────────────────────────────
  "settings.assistant": "Assistant",
  "assistant.workspaceTitle": "Assistant Workspace",
  "assistant.workspaceDesc":
    "Configure a directory for persistent AI personality and memory",
  "assistant.workspacePath": "Workspace Path",
  "assistant.workspacePathHint":
    "Select a directory (e.g. your Obsidian vault) to store assistant files",
  ...
  "assistant.checkInQ3":
    "Anything you would like me to remember going forward?",
  ...
  "assistant.switchedBanner":
    "Assistant directory has been switched to {path}. This session is no longer bound to assistant features.",
  ...
  "assistant.confirmEmptyDesc":
    "This is an empty directory. Initialize it as a new assistant workspace?",
  "assistant.confirmNormalTitle": "Initialize Workspace Here",
  "assistant.confirmNormalDesc":
    "This directory already contains files. Initialize assistant workspace here?",
  "assistant.confirmNormalHint":
    "An .assistant folder, soul.md, memory.md and other assistant files will be created.",
  "assistant.confirmInitialize": "Initialize",
  "assistant.confirmExistingTitle": "Existing Workspace Detected",
  "assistant.confirmExistingDesc":
    "This directory already contains an assistant workspace. How would you like to proceed?",
  ...
  "assistant.confirmPartialDesc":
    "Partial assistant data was found in this directory. Repair and continue using it?",
  "assistant.confirmRepair": "Repair & Continue",
  "assistant.confirmNotFoundTitle": "Create New Directory",
  "assistant.confirmNotFoundDesc":
    "This path does not exist yet. Create the directory and initialize it as a new assistant workspace?",
  ...
  "permission.fullAccessWarning":
    "Full Access mode will automatically approve all permission requests without confirmation. This includes file writes, shell commands, and network requests. Only enable this if you fully trust the current task.",
  ...
  "cliTools.brewInstallGuide":
    "Most recommended tools require Homebrew. Run this command in your terminal to install it:",
  ...
  "cliTools.autoDescribeFailed":
    "AI description failed — check your provider settings",
  "cliTools.batchDescribe": "AI Describe",
  "cliTools.batchDescribeIntro":
    "Use AI to generate descriptions for installed tools. Results will be shown on each tool card.",
  "cliTools.batchProvider": "Provider",
  "cliTools.batchModel": "Model",
  "cliTools.batchSkipExisting":
    "Skip tools with existing descriptions ({count})",
  "cliTools.batchToolCount": "Will process {count} / {total} tools",
  "cliTools.batchNoProvider":
    "No compatible providers available. Coding Plan proxies (Kimi, GLM, MiniMax, etc.) are not supported — please configure an Anthropic API or OpenRouter provider.",
  ...
  "cliTools.noInstallMethod":
    "No automated install available for your platform",
