...
const en = {
  ...
  'git.description': 'Manage Git repositories and version control',
  'git.repositories': 'Repositories',
  'git.noRepos': 'No repositories found',
  'git.scanRepos': 'Scan for repositories',
  'git.scanNow': 'Scan now',
  'git.default': 'Default',
  'git.selectRepo': 'Select a repository',
  'git.noChanges': 'No changes',
  'git.selectFileToView': 'Select a file to view diff',
  'git.changes': 'Changes',
  ...
  'git.discard': 'Discard',
  'git.discardConfirm': 'Discard changes to this file?',
  'git.commitPlaceholder': 'Commit message (⌘/Ctrl + Enter to commit)',
  'git.commit': 'Commit',
  'git.commitMessage': 'Commit Message',
  'git.commitMessageDesc': 'Write a message describing your changes',
  'git.commitSubject': 'Subject',
  'git.commitSubjectPlaceholder': 'Brief description of this change...',
  'git.commitBody': 'Description (optional)',
  'git.commitBodyPlaceholder': 'Detailed description of this change...',
  'git.stagedFilesCount': '{count} staged file(s)',
  'git.noStagedFiles': 'No staged files',
  'git.aiGenerate': 'Generate commit message with AI',
  'git.aiGenerateFailed': 'Generation failed, please check AI configuration',
  'git.localBranches': 'Local',
  'git.remoteBranches': 'Remote',
  'git.createBranch': 'Create Branch',
  'git.newBranchName': 'Branch name',
  'git.deleteBranchConfirm': 'Delete branch "{branch}"?',
  'git.fetch': 'Fetch',
  'git.push': 'Push',
  'git.pull': 'Pull',
  'git.addRepository': 'Add Repository',
  'git.addRepositoryDesc': 'Add a local repository or clone from remote',
  'git.localRepo': 'Local Repo',
  'git.cloneRepo': 'Clone Repo',
  'git.repoPath': 'Repository Path',
  'git.repoPathPlaceholder': '/path/to/your/repository',
  'git.repoPathHint': 'Enter the full path to a local Git repository',
  'git.repoUrl': 'Repository URL',
  'git.targetDirectory': 'Target Directory',
  'git.targetDirectoryPlaceholder': 'Leave empty for default',
  'git.targetDirectoryHint': 'Repository will be cloned into this directory',
  'git.branch': 'Branch',
  'git.branchPlaceholder': 'Default: main branch',
  'git.depth': 'Depth',
  'git.depthPlaceholder': 'Full clone',
  'git.pathRequired': 'Repository path is required',
  'git.urlRequired': 'Repository URL is required',
  'git.addRepoFailed': 'Failed to add repository',
  'git.cloneFailed': 'Failed to clone repository',
  'git.repoAddedSuccess': 'Repository added successfully!',
  'git.addRepo': 'Add',
  'git.cloneRepoBtn': 'Clone',
  'git.adding': 'Adding...',
  'git.cloning': 'Cloning...',
  'git.initializing': 'Initializing...',
  'git.linking': 'Linking...',
  'git.initRepo': 'Initialize',
  'git.linkRemote': 'Link Remote',
  'git.initRepoBtn': 'Initialize Repository',
  'git.linkRemoteBtn': 'Link Remote',
  'git.initDesc': 'Will initialize a new Git repository in the current project directory:',
  'git.initHint': 'This will create a .git directory and default .gitignore file, and add this project to the repository list.',
  'git.linkDesc': 'Will link the current project to a remote repository:',
  'git.remoteUrl': 'Remote Repository URL',
  'git.initFailed': 'Failed to initialize repository',
  'git.linkFailed': 'Failed to link remote repository',
  'git.currentProject': 'Current Project',
  'git.deleteRepoConfirm': 'Remove this repository from the list?',
  'git.removeRepo': 'Remove repository',
  'git.scanResult': 'Scan complete: Found {found} repos, added {added}',
  // GitHub OAuth
  'git.githubRepos': 'GitHub',
  'git.loginWithGithub': 'Login with GitHub',
  'git.githubLoginHint': 'Login with GitHub to view and clone your repositories',
  'git.githubAuthFailed': 'GitHub authentication failed',
  'git.githubNotConfigured': 'GitHub is not configured. Please set up GitHub Client ID in Settings.',
  'git.oauthInProgress': 'Please complete authorization in your browser...',
  'git.searchRepos': 'Search repositories...',
  'git.noReposFound': 'No repositories found',
  'git.private': 'Private',
  'git.history': 'History',
  'git.commitHistory': 'Commit History',
  'git.commitHistoryDesc': 'View commit history of the repository',
  ...
  'git.failedToLoadHistory': 'Failed to load commit history',
  'git.setAsDefault': 'Set as Default',
  'git.openInFileManager': 'Open in File Manager',
  'git.stash': 'Stash',
  'git.stashChanges': 'Stash Changes',
  'git.stashChangesDesc': 'Save current changes to stash for later recovery',
  'git.stashMessagePlaceholder': 'Stash message (optional)',
  'git.includeUntracked': 'Include untracked files',
  'git.stashing': 'Stashing...',
  'git.gitSettings': 'Git Settings',
  'git.gitSettingsDesc': 'Configure Git options',
  'git.defaultCloneDir': 'Default Clone Directory',
  'git.defaultCloneDirPlaceholder': 'Leave empty to use system default',
  'git.defaultCloneDirHint': 'Default location when cloning repositories from GitHub',
  'git.selectCloneDir': 'Select Clone Directory',
  'git.browse': 'Browse',
  'git.settingsSaved': 'Settings saved',
  'git.saving': 'Saving...',
  'git.publish': 'Publish',
  'git.addRemote': 'Add Remote',
  'git.addRemoteDesc': 'Add a remote repository URL to push your code.',
  'git.remoteName': 'Name',
  'git.remoteUrlRequired': 'Remote URL is required',
  'git.addRemoteFailed': 'Failed to add remote',
  'git.publishToGithub': 'Publish to GitHub',
  'git.publishToGithubDesc': 'Create a new repository on GitHub and push your code.',
  'git.loginToPublish': 'Login to GitHub to publish your repository.',
  'git.newRepoName': 'Repository Name',
  'git.repoNameRequired': 'Repository name is required',
  'git.repoDesc': 'Description',
  'git.repoDescPlaceholder': 'A short description of your project (optional)',
  'git.visibility': 'Visibility',
  'git.visibilityPublic': 'Public',
  'git.visibilityPrivate': 'Private',
  'git.publicHint': 'Anyone can see this repository',
  'git.privateHint': 'Only you can see this repository',
  'git.createRepoFailed': 'Failed to create repository',
  'git.publishFailed': 'Failed to publish repository',
  'git.publishRepo': 'Publish Repository',
  'git.selectCommitToView': 'Select a commit to view changes',
  'git.noDiff': 'No changes in this commit',
  'git.addRepoForProject': 'Add this project as a repository to manage Git changes',

  // Settings - GitHub
  'settings.github': 'GitHub',
  'settings.githubToken': 'Personal Access Token',
  'settings.githubTokenHint': 'Generate a token at github.com/settings/tokens with repo and read:user scopes',
  'settings.githubTokenPlaceholder': 'ghp_xxx...',
  'settings.githubHowToSetup': 'Generate Token',
  'settings.githubConfigured': 'GitHub configured',
  'settings.githubNotSetUp': 'Not configured',
  'settings.githubVerify': 'Verify',
  'settings.githubVerifySuccess': 'Token verified successfully',
  'settings.githubVerifyFailed': 'Token verification failed',
} as const;
