...
const en = {
  ...
  'globalSearch.description': 'Search across sessions, messages, and files',
  'globalSearch.placeholder': 'Search sessions, messages, and files',
  'globalSearch.hint': 'Search across conversations, message history, and recent files',
  'globalSearch.emptyDescription': 'Jump to a session, reopen a file, or find the exact message you need.',
  'globalSearch.hintPrefix': 'Scope filters',
  'globalSearch.toNarrowScope': 'to narrow scope',
  'globalSearch.all': 'All',
  'globalSearch.noResults': 'No results found',
  'globalSearch.noResultsHint': 'Try a different keyword or switch scope.',
  'globalSearch.searching': 'Searching...',
  'globalSearch.resultsSummary': '{count} matches',
  'globalSearch.sessions': 'Sessions',
  'globalSearch.messages': 'Messages',
  'globalSearch.files': 'Files',
  'globalSearch.fileLabel': 'File',
  'globalSearch.directoryLabel': 'Folder',
  'globalSearch.scopeSessionsHint': 'Session titles and project names',
  'globalSearch.scopeMessagesHint': 'Message history and tool output',
  'globalSearch.scopeFilesHint': 'Recent workspace files',
  ...
  'mcp.builtin.memory.description': 'Search, read, and inspect workspace memory; remember, correct, and forget with write permission.',
  ...
  "assistant.quickActions.identityUnavailable": "The current provider configuration cannot be identified. Check CodePilot data-directory permissions, then retry.",
  "assistant.quickActions.persistenceUnavailable": "Provider failure state could not be saved, so dynamic suggestions are paused. Check CodePilot data-directory permissions and disk space, then retry.",
  "assistant.quickActions.workspaceUnavailable": "Configure an assistant workspace, then retry generating suggestions.",
  "assistant.quickActions.retry": "Retry suggestions",
  "assistant.quickActions.retryAfter": "Cooling down until {time}; retry becomes available afterward. Provider configuration changes are checked immediately.",
  "assistant.quickActions.retryCost": "Retry uses the current provider and may consume model quota. Cooldown and configuration restrictions still apply.",
  "assistant.quickActions.retryResult": "Retry result: {status}",
  "assistant.quickActions.updated": "Dynamic suggestions updated.",
  "memoryRecords.reasonRetryExhausted": "Automatic extraction reached its 3-attempt limit. This batch will not retry; you can still save memory manually.",
  "memoryRecords.reasonIdentityUnavailable": "The current provider configuration cannot be identified. Check CodePilot data-directory permissions, then retry.",
  "memoryRecords.reasonPersistenceUnavailable": "Provider failure state could not be saved, so automatic extraction is paused. Check CodePilot data-directory permissions and disk space, then retry.",
  "assistant.quickActions.generating": "Dynamic suggestions are being generated.",
  "assistant.quickActions.cooldown": "Dynamic suggestions are waiting before retrying.",
  "assistant.quickActions.credentials": "Current credentials cannot generate dynamic suggestions. Check provider credentials, then retry.",
  'assistant.quickActions.policy': 'The current model policy does not allow dynamic suggestions. Existing suggestions remain available.',
  "assistant.quickActions.unavailable": "Dynamic suggestions are unavailable. You can retry.",
  'memoryRecords.reasonCredentials': 'Add API credentials for a supported provider in Settings > Providers, or continue saving memories manually.',
  'memoryRecords.reasonProvider': 'The selected provider is unavailable. Check your provider selection in Settings > Providers.',
  'memoryRecords.reasonUnsupported': 'This authentication method cannot run background extraction. Choose a provider that supports auxiliary calls, or save manually.',
  'memoryRecords.reasonPolicy': 'The provider policy does not allow this background request. Review the provider configuration; manual memory remains available.',
  'memoryRecords.reasonRequest': 'Check the provider connection and quota, then retry. Manual memory remains available.',
  'memoryRecords.reasonEmpty': 'The model returned no usable response. Retry, or save the original text manually.',
  'memoryRecords.reasonCancelled': 'The request was cancelled. Retry if you still want automatic extraction.',
  'memoryRecords.reasonInFlight': 'An extraction request is already running. Its status will refresh automatically.',
  'memoryRecords.reasonBinding': 'The source conversation is no longer linked to this assistant. Open the assistant conversation to continue.',
  'memoryRecords.reasonSource': 'The original message is unavailable. Save the information manually if it is still needed.',
  'memoryRecords.reasonRevoked': 'You corrected or forgot memory from this source. It will not be extracted automatically again.',
  'memoryRecords.reasonStorage': 'Extraction or local storage failed. Check the assistant directory permissions, then retry or save manually.',
  // Local memory management
  "memoryRecords.storageCapacity": "Memory storage reached its 2 MiB limit. Forget unneeded records to free space, then retry. Keep source tombstones to prevent re-extraction. If the list cannot be read, back up memory/records.md and restore a valid backup within the limit.",
  "memoryRecords.corrupt": "memory/records.md is malformed or is not a managed memory file. Refreshing cannot repair it. Back it up and restore a valid managed backup; do not clear or overwrite it and lose provenance or forgotten-source records.",
  "memoryRecords.storage": "Memory storage is unavailable. Check workspace permissions and free disk space, then retry after fixing them. Existing memory files are not automatically overwritten.",
  "memoryRecords.unsafePath": "The memory path uses an unsupported symlink or file type. Back it up, restore a regular directory and valid memory file in this workspace, then refresh.",
  "memoryRecords.retryRequested": "Retry requested. The page refreshes actual job status; cooling-down jobs and unresolved storage failures do not call the model again.",
  "memoryRecords.retryAfter": "Cooling down until {time}; retry becomes available afterward.",
  "memoryRecords.reasonConfiguration": "The current provider configuration or account needs attention. Fix it before resuming extraction.",
  "assistant.quickActions.configuration": "The current provider configuration or account needs attention. Fix it, then retry.",
  "memoryRecords.conflict": "Memory changed or the workspace switched. Refresh before saving; your draft is preserved.",
  "memoryRecords.busy": "Another process is saving memory, or the writer lock cannot be verified. Close other CodePilot instances using this workspace, then retry. Locks from exited local writers recover automatically.",
  "memoryRecords.secret": "The memory contains a credential or token. Remove it before saving.",
  "memoryRecords.invalid": "Enter a memory of 1–16000 characters.",
  "memoryRecords.unavailable": "Memory could not be read or saved. Check the assistant directory and file permissions, then refresh.",
  "memoryRecords.ariaLabel": "Memory management",
  "memoryRecords.title": "Memory",
  "memoryRecords.storageHint": "Saved verbatim in memory/records.md in your assistant directory, without a model call. Existing memory files remain unchanged.",
  "memoryRecords.refresh": "Refresh",
  "memoryRecords.extractionTitle": "Automatic extraction status",
  "memoryRecords.retry": "Retry extraction",
  "memoryRecords.extractionCost": "Automatic extraction is a model enhancement and may use your model quota. Manual save, correction and forgetting do not require a model.",
  "memoryRecords.statusUnavailable": "Extraction status is unavailable. Manual memory remains available.",
  "memoryRecords.pendingTurns": "{count} successful turns are queued; extraction starts after 3 successful turns in the same conversation.",
  "memoryRecords.capacity": "The extraction ledger is at capacity; new jobs are not queued.",
  "memoryRecords.noJobs": "No extraction jobs have been queued.",
  "memoryRecords.pending": "Pending",
  "memoryRecords.running": "Extracting",
  "memoryRecords.saved": "Saved",
  "memoryRecords.nothing": "No durable facts found",
  "memoryRecords.modelUnavailable": "Model unavailable",
  "memoryRecords.failed": "Extraction or storage failed",
  "memoryRecords.cooldown": "Cooling down after failure",
  "memoryRecords.sourceRevoked": "Revoked source; not saved again",
  "memoryRecords.skipped": "Source or binding unavailable; skipped",
  "memoryRecords.unknownStatus": "Status unavailable",
  "memoryRecords.loading": "Loading memories…",
  "memoryRecords.correctTitle": "Correct memory",
  "memoryRecords.rememberTitle": "Remember verbatim",
  "memoryRecords.cancelCorrection": "Cancel correction",
  "memoryRecords.saving": "Saving…",
  "memoryRecords.empty": "No memories have been saved through this feature yet.",
  "memoryRecords.active": "Active",
  "memoryRecords.superseded": "Superseded",
  "memoryRecords.revoked": "Forgotten",
  "memoryRecords.sourceTitle": "View source",
  "memoryRecords.manualSource": "Saved verbatim by the user in memory management",
  "memoryRecords.toolSource": "Recorded by a conversation tool; not individually confirmed by the user",
  "memoryRecords.extractedSource": "Extracted from a conversation; not individually confirmed by the user",
  "memoryRecords.openConversation": "Open source conversation",
  "memoryRecords.messageId": "Message ID: ",
  "memoryRecords.recordId": "Record ID: ",
  "memoryRecords.correct": "Correct",
  "memoryRecords.forget": "Forget",
  "memoryRecords.forgetDescription": "Remove this memory and its prior versions. Source identifiers remain to prevent automatic re-extraction. The original conversation and existing memory files are retained.",
  "memoryRecords.confirmForget": "Confirm forget",
