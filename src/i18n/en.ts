...
const en = {
  ...
  'tasks.description': 'Manage and view Claude Code scheduled tasks',
  'tasks.createTask': 'Create Task',
  'tasks.createDescription': 'Create a new scheduled task',
  'tasks.taskName': 'Task Name',
  'tasks.taskNamePlaceholder': 'e.g., Daily Report',
  'tasks.taskPrompt': 'Task Prompt',
  'tasks.taskPromptPlaceholder': 'Describe what the task should do...',
  'tasks.scheduleType': 'Schedule Type',
  'tasks.scheduleValue': 'Schedule Value',
  'tasks.interval': 'Interval',
  'tasks.cron': 'Cron',
  'tasks.once': 'Once',
  'tasks.cronFormat': 'Format: min hour dom month dow',
  'tasks.intervalFormat': 'Format: 30m, 1h, 1d',
  'tasks.priority': 'Priority',
  'tasks.priorityLow': 'Low',
  'tasks.priorityNormal': 'Normal',
  'tasks.priorityUrgent': 'Urgent',
  'tasks.notifyOnComplete': 'Notify on Complete',
  'tasks.cancel': 'Cancel',
  'tasks.create': 'Create',
  'tasks.workingDirectory': 'Working Directory',
  'tasks.workingDirectoryPlaceholder': 'e.g. /Users/jackdu/Documents/agent',
  'tasks.noScheduledTasks': 'No scheduled tasks',
  'tasks.noScheduledTasksDescription': 'Create a scheduled task to automate your work',
