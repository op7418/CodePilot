...
const zh: Record<TranslationKey, string> = {
  ...
  'tasks.description': '管理和查看 Claude Code 定时任务',
  'tasks.createTask': '创建任务',
  'tasks.createDescription': '创建一个新的定时任务',
  'tasks.taskName': '任务名称',
  'tasks.taskNamePlaceholder': '例如：每日汇报',
  'tasks.taskPrompt': '任务提示',
  'tasks.taskPromptPlaceholder': '描述任务要执行的内容...',
  'tasks.scheduleType': '调度类型',
  'tasks.scheduleValue': '调度值',
  'tasks.interval': '间隔',
  'tasks.cron': 'Cron',
  'tasks.once': '一次',
  'tasks.cronFormat': '格式：分 时 日 月 周',
  'tasks.intervalFormat': '格式：30m, 1h, 1d',
  'tasks.priority': '优先级',
  'tasks.priorityLow': '低',
  'tasks.priorityNormal': '普通',
  'tasks.priorityUrgent': '紧急',
  'tasks.notifyOnComplete': '完成后通知',
  'tasks.cancel': '取消',
  'tasks.create': '创建',
  'tasks.workingDirectory': '工作目录',
  'tasks.workingDirectoryPlaceholder': '例如：/Users/jackdu/Documents/agent',
  'tasks.noScheduledTasks': '暂无定时任务',
  'tasks.noScheduledTasksDescription': '创建一个定时任务来自动化你的工作',
  'tasks.nextRun': '下次执行',
  'tasks.lastRun': '上次执行',
  'tasks.errors': '错误次数',
  'tasks.in': '后',
  ...
  'tasks.delete': '删除',
  'tasks.status': '状态',
  'tasks.lastStatus': '上次状态',
  'tasks.lastResult': '上次结果',
