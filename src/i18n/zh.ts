...
const zh: Record<TranslationKey, string> = {
  ...
  'globalSearch.description': '跨会话、消息记录和文件检索',
  'globalSearch.placeholder': '搜索会话、消息和文件',
  'globalSearch.hint': '搜索对话、消息记录和最近文件',
  'globalSearch.emptyDescription': '快速跳转到会话、重新打开文件，或定位一条具体消息。',
  'globalSearch.hintPrefix': '范围过滤',
  'globalSearch.toNarrowScope': '限定搜索范围',
  'globalSearch.all': '全部',
  'globalSearch.noResults': '未找到结果',
  'globalSearch.noResultsHint': '换个关键词，或切换到其他范围再试。',
  'globalSearch.searching': '搜索中...',
  'globalSearch.resultsSummary': '{count} 项匹配',
  'globalSearch.sessions': '会话',
  'globalSearch.messages': '消息',
  'globalSearch.files': '文件',
  'globalSearch.fileLabel': '文件',
  'globalSearch.directoryLabel': '文件夹',
  'globalSearch.scopeSessionsHint': '按会话标题和项目名查找',
  'globalSearch.scopeMessagesHint': '检索消息历史和工具输出',
  'globalSearch.scopeFilesHint': '检索最近工作区里的文件',
  ...
  'mcp.builtin.memory.description': '搜索、读取和查看工作区记忆；获得写入权限后可记住、更正和遗忘。',
  ...
  "assistant.quickActions.identityUnavailable": "无法确认当前服务商配置。请检查 CodePilot 数据目录权限，修复后重试。",
  "assistant.quickActions.persistenceUnavailable": "无法保存服务商失败状态，动态建议已暂停。请检查 CodePilot 数据目录权限和磁盘空间后重试。",
  "assistant.quickActions.workspaceUnavailable": "请先配置助理工作区，然后重试生成建议。",
  "assistant.quickActions.retry": "重试动态建议",
  "assistant.quickActions.retryAfter": "冷却至 {time}，之后可重试；修改服务商配置后会重新检查。",
  "assistant.quickActions.retryCost": "重试会使用当前服务商，可能消耗模型额度；冷却与配置限制仍然生效。",
  "assistant.quickActions.retryResult": "重试结果：{status}",
  "assistant.quickActions.updated": "动态建议已更新。",
  "memoryRecords.reasonRetryExhausted": "自动提取已达到 3 次尝试上限，本批次不再重试。你仍可手动保存记忆。",
  "memoryRecords.reasonIdentityUnavailable": "无法确认当前服务商配置。请检查 CodePilot 数据目录权限，修复后重试。",
  "memoryRecords.reasonPersistenceUnavailable": "无法保存服务商失败状态，自动提取已暂停。请检查 CodePilot 数据目录权限和磁盘空间后重试。",
  "assistant.quickActions.generating": "正在生成动态建议。",
  "assistant.quickActions.cooldown": "动态建议暂缓重试。",
  "assistant.quickActions.credentials": "当前认证无法生成动态建议，请检查服务商凭据后重试。",
  'assistant.quickActions.policy': '当前模型的调用策略不允许动态建议，现有建议可继续使用。',
  "assistant.quickActions.unavailable": "动态建议暂不可用，可以重试。",
  'memoryRecords.reasonCredentials': '请在设置的服务商页面添加受支持服务商的 API 凭据，或继续手动保存记忆。',
  'memoryRecords.reasonProvider': '当前服务商不可用，请到设置的服务商页面检查所选服务商。',
  'memoryRecords.reasonUnsupported': '当前认证方式不能运行后台提取。请选择支持辅助调用的服务商，或手动保存。',
  'memoryRecords.reasonPolicy': '服务商调用策略不允许此后台请求。请检查服务商配置；手动记忆仍可使用。',
  'memoryRecords.reasonRequest': '请检查服务商连接与额度后重试，手动记忆仍可使用。',
  'memoryRecords.reasonEmpty': '模型未返回可用内容。可以重试，或手动记住原文。',
  'memoryRecords.reasonCancelled': '请求已取消。如仍需自动提取，可以重试。',
  'memoryRecords.reasonInFlight': '已有提取请求正在执行，状态会自动刷新。',
  'memoryRecords.reasonBinding': '来源会话已不再绑定此助理。请打开助理会话后继续。',
  'memoryRecords.reasonSource': '来源消息已不可用。如仍需记住这些信息，请手动保存。',
  'memoryRecords.reasonRevoked': '你已更正或忘记此来源中的记忆，不会再次自动提取。',
  'memoryRecords.reasonStorage': '提取或本地保存失败。请检查助理目录权限后重试，或手动保存。',
  // Local memory management
  "memoryRecords.storageCapacity": "记忆文件已达到 2 MiB 容量限制。请先遗忘不再需要的记忆释放空间，再重试；不要删除来源标识，否则已遗忘内容可能再次提取。如果列表无法读取，请先备份 memory/records.md 并恢复未超限的有效备份。",
  "memoryRecords.corrupt": "memory/records.md 格式损坏或不属于受管理记忆，刷新不能修复。请先备份该文件，再恢复有效的受管理记忆备份；不要直接清空或覆盖，以免丢失来源与遗忘记录。",
  "memoryRecords.storage": "记忆存储不可用。请检查工作区权限和磁盘剩余空间，恢复后再重试；现有记忆文件不会自动覆盖。",
  "memoryRecords.unsafePath": "记忆目录或文件使用了不支持的符号链接或文件类型。请先备份，并在当前工作区恢复普通目录及有效记忆文件后刷新。",
  "memoryRecords.retryRequested": "已请求重试。页面会刷新真实任务状态；仍在冷却或存储未修复的任务不会重新调用模型。",
  "memoryRecords.retryAfter": "冷却至 {time}，之后可重试。",
  "memoryRecords.reasonConfiguration": "当前服务商配置或账户需要处理，请修复配置后再恢复提取。",
  "assistant.quickActions.configuration": "当前服务商配置或账户需要处理，修复后重试。",
  "memoryRecords.conflict": "记忆已被修改，或当前目录已切换。请刷新后再保存；你的输入仍保留。",
  "memoryRecords.busy": "另一个进程正在保存记忆，或写入锁暂时无法验证。请关闭使用同一工作区的其他 CodePilot 实例后重试；已退出的本机写入进程会自动恢复。",
  "memoryRecords.secret": "内容包含密钥或令牌，请移除后再保存。",
  "memoryRecords.invalid": "请输入 1–16000 个字符的记忆。",
  "memoryRecords.unavailable": "无法读取或保存记忆。请检查助理目录与文件权限后刷新。",
  "memoryRecords.ariaLabel": "记忆管理",
  "memoryRecords.title": "记忆",
  "memoryRecords.storageHint": "原文保存在助理目录 memory/records.md，不调用模型。旧有记忆文件保持原样。",
  "memoryRecords.refresh": "刷新",
  "memoryRecords.extractionTitle": "自动提取状态",
  "memoryRecords.retry": "重试提取",
  "memoryRecords.extractionCost": "自动提取是可选的模型增强，可能消耗模型额度；手动记住、更正和忘记不依赖模型。",
  "memoryRecords.statusUnavailable": "无法读取自动提取状态。手动记忆仍可使用。",
  "memoryRecords.pendingTurns": "已有 {count} 个成功回合暂存；同一会话凑满 3 个成功回合后自动提取。",
  "memoryRecords.capacity": "自动提取记录已达容量上限，新任务暂不入队。",
  "memoryRecords.noJobs": "尚无自动提取任务。",
  "memoryRecords.pending": "等待处理",
  "memoryRecords.running": "提取中",
  "memoryRecords.saved": "已保存",
  "memoryRecords.nothing": "未发现需记忆的信息",
  "memoryRecords.modelUnavailable": "模型暂不可用",
  "memoryRecords.failed": "提取或保存失败",
  "memoryRecords.cooldown": "失败后冷却中",
  "memoryRecords.sourceRevoked": "来源已撤销，未再次保存",
  "memoryRecords.skipped": "来源或绑定不可用，已跳过",
  "memoryRecords.unknownStatus": "状态不可用",
  "memoryRecords.loading": "正在读取记忆…",
  "memoryRecords.correctTitle": "更正记忆",
  "memoryRecords.rememberTitle": "记住原文",
  "memoryRecords.cancelCorrection": "取消更正",
  "memoryRecords.saving": "正在保存…",
  "memoryRecords.empty": "还没有通过此入口保存的记忆。",
  "memoryRecords.active": "当前有效",
  "memoryRecords.superseded": "已被更正",
  "memoryRecords.revoked": "已忘记",
  "memoryRecords.sourceTitle": "查看来源",
  "memoryRecords.manualSource": "用户在记忆管理中保存的原文",
  "memoryRecords.toolSource": "由会话工具记录，未经用户逐条确认",
  "memoryRecords.extractedSource": "从会话提取，未经用户逐条确认",
  "memoryRecords.openConversation": "打开来源会话",
  "memoryRecords.messageId": "消息 ID：",
  "memoryRecords.recordId": "记录 ID：",
  "memoryRecords.correct": "更正",
  "memoryRecords.forget": "忘记",
  "memoryRecords.forgetDescription": "将移除这条记忆及其旧版本正文，保留来源标识以阻止再次自动提取。原会话和旧有记忆文件不会删除。",
  "memoryRecords.confirmForget": "确认忘记",
